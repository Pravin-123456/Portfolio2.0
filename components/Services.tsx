...
const Services: React.FC<ServicesProps> = ({ id }) => {
  return (
    <section id={id} className="relative min-h-screen w-full flex flex-col justify-center py-24 overflow-hidden">
      ...
      <div className="container mx-auto px-6 md:px-12 xl:px-16 2xl:px-24 relative z-10 flex flex-col items-center">
        ...
        <MotionH2
            ...
            className="text-5xl md:text-7xl 2xl:text-[9rem] font-bold text-white mb-20 2xl:mb-32 text-center"
        >
            SERVICES
        </MotionH2>
        ...
        <div className="w-full flex justify-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 xl:gap-12 w-full max-w-6xl">
